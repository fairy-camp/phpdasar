...
<main class="form-signin w-100 m-auto">
    ...
    <form action="" method="post">
        ...
        <div class="form-floating">
            <input type="password" class="form-control mb-0" id="floatingPassword password" name="password" placeholder="Password">
            <label for="floatingPassword password">Password</label>
        </div>

        <div class="form-floating">
            <input type="password" class="form-control" id="floatingPassword password2" name="password2" placeholder="Password">
            <label for="floatingPassword password">Konfirmasi Password</label>
        </div>
